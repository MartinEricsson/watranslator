...
const I64_MAX_AS_F64 = Number(9223372036854775807n);
const I64_MIN_AS_F64 = Number(-9223372036854775808n);
const U64_MAX_AS_F64 = Number(18446744073709551615n);
const TEN_QUINTILLION_AS_F64 = Number(10000000000000000000n);
...
async function testTypeConversionI64ToF64(debug = false) {
	try {
		...
		const tests = [
			...
			{
				name: "convert_i64_s_to_f64",
				expected: I64_MAX_AS_F64,
				func: "convert_i64_s_to_f64",
				params: [9223372036854775807n],
			}, // Max i64
			{
				name: "convert_i64_s_to_f64",
				expected: I64_MIN_AS_F64,
				func: "convert_i64_s_to_f64",
			...
			{
				name: "convert_i64_u_to_f64",
				expected: U64_MAX_AS_F64,
				func: "convert_i64_u_to_f64",
				params: [-1n],
			}, // Unsigned interpretation of -1
			{
				name: "convert_i64_u_to_f64",
				expected: TEN_QUINTILLION_AS_F64,
				func: "convert_i64_u_to_f64",
