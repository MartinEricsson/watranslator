	...
	try {
		...
		for (let i = 0; i < 10; i++) {
			...
			assert.strictEqual(
				actual,
				expected,
				`Initial byte at offset ${i} should be ${expected}`,
			);
		...
		for (let i = 0; i < 10; i++) {
			...
			assert.strictEqual(
				actual,
				expected,
				`Byte at offset ${i} after fill should be ${expected.toString(16)}`,
			);
			if (debug)
				console.log(
					`Byte at offset ${i} after fill: 0x${actual.toString(16).padStart(2, "0")} ✓`,
				);
		}
		...
		for (let i = 0; i < 10; i++) {
			...
			assert.strictEqual(
				actual,
				expected,
				`Byte at offset ${i} after clear should be ${expected.toString(16)}`,
			);
			if (debug)
				console.log(
					`Byte at offset ${i} after clear: 0x${actual.toString(16).padStart(2, "0")} ✓`,
				);
		}
		...
		for (let i = 0; i < 5; i++) {
			...
			if (offset < LARGE_FILL_OFFSET + LARGE_FILL_SIZE) {
				...
				if (debug)
					console.log(
						`Byte at offset ${offset}: 0x${memoryView[offset].toString(16).padStart(2, "0")} ✓`,
					);
			}
		}
		...
		for (let i = 0; i < 5; i++) {
			...
			if (debug)
				console.log(
					`Byte at offset ${50 + i}: 0x${actual.toString(16).padStart(2, "0")}`,
				);
		}
		...
		for (let i = 0; i < 5; i++) {
			...
			assert.strictEqual(
				actual,
				expected,
				`Byte at offset ${20 + i} after copy should be ${expected.toString(16)}`,
			);
			if (debug)
				console.log(
					`Byte at offset ${20 + i} after copy: 0x${actual.toString(16).padStart(2, "0")} ✓`,
				);
		}
		...
		for (let i = 0; i < 10; i++) {
			...
			if (debug)
				console.log(
					`Byte at offset ${100 + i}: 0x${actual.toString(16).padStart(2, "0")} ✓`,
				);
		}
		console.log(
			"✅ memory.copy correctly handled overlapping regions (upward)",
		);
		...
		for (let i = 0; i < 10; i++) {
			...
			if (debug)
				console.log(
					`Byte at offset ${200 + i}: 0x${actual.toString(16).padStart(2, "0")} ✓`,
				);
		}
		console.log(
			"✅ memory.copy correctly handled overlapping regions (downward)",
		);
		...
		for (let i = 0; i < 10; i++) {
			...
			if (debug)
				console.log(
					`Byte at offset ${300 + i} after init: 0x${actual.toString(16).padStart(2, "0")} ✓`,
				);
		}
		console.log(
			"✅ memory.init correctly initialized memory from passive data segment",
		);
		...
		for (let i = 0; i < 5; i++) {
			...
			if (debug)
				console.log(
					`Byte at offset ${310 + i} after partial init: 0x${actual.toString(16).padStart(2, "0")} ✓`,
				);
		}
		console.log(
			"✅ memory.init correctly initialized memory from offset in passive data segment",
		);
