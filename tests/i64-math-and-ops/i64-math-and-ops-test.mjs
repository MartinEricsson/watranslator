...
async function i64MathAndOps(debug = false) {
	try {
		...
		const { wasmBuffer } = await readTestData(
			"i64-math-and-ops/i64-math-and-ops.wat",
		);
		...
		const tests = [
			...
			{
				name: "i64_const_hex",
				expected: BigInt("0xFF"),
				func: "i64_const_hex",
				params: [],
			},
			{
				name: "i64_const_large",
				expected: BigInt("9223372036854775807"),
				func: "i64_const_large",
				params: [],
			},
			{
				name: "i64_const_small",
				expected: BigInt("-9223372036854775808"),
				func: "i64_const_small",
				params: [],
			},
			{
				name: "i64_add",
			...
			{
				name: "i64_shl",
				expected: BigInt(42) << BigInt(1),
				func: "i64_shl",
				params: [BigInt(42), BigInt(1)],
			},
			{
				name: "i64_shr_s",
				expected: BigInt("4611686018427387903"),
				func: "i64_shr_s",
				params: [BigInt("9223372036854775807"), BigInt(1)],
			},
			{
				name: "i64_shr_u",
				expected: BigInt("4611686018427387903"),
			...
			},
			{
				...
				expected: BigInt(-1),
				func: "i64_extend16_s",
				params: [BigInt(0xffff)],
			},
			{
				name: "i64_extend32_s",
				expected: BigInt(-1),
				func: "i64_extend32_s",
				params: [BigInt(0xffffffff)],
			},
			{
				name: "i64_extend_i32_s",
				expected: BigInt(-1),
				func: "i64_extend_i32_s",
				params: [-1],
			},
			{
