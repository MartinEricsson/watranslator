...
async function TestF64MathAndOps(debug = false) {
	try {
		const { wasmBuffer } = await readTestData(
			"f64-math-and-ops/f64-math-and-ops.wat",
			debug,
		);
		...
		const tests = [
			...
			// Generated by 🤖
			{
				name: "const_large_f64",
				expected: 1.7976931348623157e308,
				func: "const_large_f64",
				params: [],
			},
			{
				name: "const_small_f64",
				expected: 2.2250738585072014e-308,
				func: "const_small_f64",
				params: [],
			},
			...
			{
				name: "ne (different values)",
				expected: 1,
				func: "ne",
				params: [42.0, 43.0],
			},
			{ name: "ne (NaN)", expected: 1, func: "ne", params: [Number.NaN, 0.0] },
