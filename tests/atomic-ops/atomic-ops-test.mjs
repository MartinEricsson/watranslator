...
async function testAtomicOps(debug = true) {
	try {
		...
		const testCases = [
			{
				...
				test: () => {
					...
					return previousValue === expectedPrevious && newValue === expectedNew;
				},
			},
			{
			...
			},
			{
				...
				test: () => {
					...
					const previousValue = instance.exports.atomicAdd16_64(
						address,
						0x0001n,
					);
					const newValue = instance.exports.load64(address);
			...
			},
			{
				...
				test: () => {
					...
					const previousValue = instance.exports.atomicAdd32_64(
						address,
						0x00000001n,
					);
					const newValue = instance.exports.load64(address);
					...
					return (
						previousValue === 0xdeadbeefn &&
						(newValue & 0xffffffffn) === 0xdeadbef0n
					);
				},
			},
			// Generated by 🤖
			...
			},
			{
				...
				test: () => {
					...
					// Initialize with a value
					instance.exports.store64(address, 0x800000000000beefn);
					const previousValue = instance.exports.atomicSub16_64(
						address,
						0x0001n,
					);
					const newValue = instance.exports.load64(address);
			...
			},
			{
				...
				test: () => {
					...
					// Initialize with a value
					instance.exports.store64(address, 0x80000000deadbeefn);
					const previousValue = instance.exports.atomicSub32_64(
						address,
						0x00000001n,
					);
					const newValue = instance.exports.load64(address);
					...
					return (
						previousValue === 0xdeadbeefn &&
						(newValue & 0xffffffffn) === 0xdeadbeeen
					);
				},
			},
			// Generated by 🤖
			...
			},
			{
				...
				test: () => {
					...
					const previousValue = instance.exports.atomicAnd16_64(
						address,
						0xff00n,
					);
					const newValue = instance.exports.load64(address);
			...
			},
			{
				...
				test: () => {
					...
					const previousValue = instance.exports.atomicAnd32_64(
						address,
						0xffff0000n,
					);
					const newValue = instance.exports.load64(address);
					...
					return (
						previousValue === 0xffffffffn &&
						(newValue & 0xffffffffn) === 0xffff0000n
					);
				},
			},
			...
			// i32 atomic compare exchange tests
			{
				...
				test: () => {
					const address = 84;
					instance.exports.store(address, 42);
					const previousValue = instance.exports.atomicCmpxchg32(
						address,
						42,
						99,
					);
			...
			// i64 atomic compare exchange tests
			{
				...
				test: () => {
					const address = 136;
					instance.exports.store64(address, 42n);
					const previousValue = instance.exports.atomicCmpxchg64(
						address,
						42n,
						99n,
					);
			...
			},
			{
				...
				test: () => {
					...
					const previousValue = instance.exports.atomicOr16_64(
						address,
						0x0f0fn,
					);
					const newValue = instance.exports.load64(address);
			...
			},
			{
				...
				test: () => {
					...
					const previousValue = instance.exports.atomicOr32_64(
						address,
						0x0f0f0f0fn,
					);
					const newValue = instance.exports.load64(address);
					...
					return (
						previousValue === 0xf0f0f0f0n &&
						(newValue & 0xffffffffn) === 0xffffffffn
					);
				},
			},
			...
			},
			{
				...
				test: () => {
					...
					instance.exports.store64(address, 0x000000000000ffffn);
					const previousValue = instance.exports.atomicXor16_64(
						address,
						0xaaaan,
					);
					const newValue = instance.exports.load64(address);
			...
			},
			{
				...
				test: () => {
					...
					instance.exports.store64(address, 0x00000000ffffffffn);
					const previousValue = instance.exports.atomicXor32_64(
						address,
						0xaaaaaaaan,
					);
					const newValue = instance.exports.load64(address);
					...
					return (
						previousValue === 0xffffffffn &&
						(newValue & 0xffffffffn) === 0x55555555n
					);
				},
			},
			...
			},
			{
				...
				test: () => {
					...
					const previousValue = instance.exports.atomicXchg16_64(
						address,
						0x9999n,
					);
					const newValue = instance.exports.load64(address);
			...
			},
			{
				...
				test: () => {
					...
					const previousValue = instance.exports.atomicXchg32_64(
						address,
						0x99999999n,
					);
					const newValue = instance.exports.load64(address);
					...
					return (
						previousValue === 0x42424242n &&
						(newValue & 0xffffffffn) === 0x99999999n
					);
				},
			},
			// Tests for atomic compare-exchange operations
			{
				...
				test: () => {
					...
					const previousValue = instance.exports.atomicCmpxchg8(
						address,
						0xab,
						0xcd,
					);
			...
			},
			{
				...
				test: () => {
					...
					instance.exports.store(address, 0xabcd);
					const previousValue = instance.exports.atomicCmpxchg16(
						address,
						0xabcd,
						0x1234,
					);
			...
			},
			{
				...
				test: () => {
					...
					const previousValue = instance.exports.atomicCmpxchg8_64(
						address,
						0xabn,
						0xcdn,
					);
			...
			},
			{
				...
				test: () => {
					...
					const previousValue = instance.exports.atomicCmpxchg16_64(
						address,
						0xabcdn,
						0x1234n,
					);
			...
			},
			{
				...
				test: () => {
					...
					const previousValue = instance.exports.atomicCmpxchg32_64(
						address,
						0xabcdef01n,
						0x12345678n,
					);
					...
					return (
						previousValue === 0xabcdef01n &&
						(newValue & 0xffffffffn) === 0x12345678n
					);
				},
			},
		];
		...
		// atomic fence test
		const { wasmBuffer: atomicFenceBuffer } = await readTestData(
			"atomic-ops/atomic-fence.wat",
			debug,
		);
		const { instance: atomicFenceInstance } =
			await WebAssembly.instantiate(atomicFenceBuffer);
		try {
		...
		console.error(
			"Error during WebAssembly instantiation or execution:",
			error,
		);
		return false;
	}
