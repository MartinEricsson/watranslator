		...
		if (typeof WebAssembly !== "undefined") {
			...
			if (typeof instance.exports.add_float === "function") {
				...
				for (const test of testCasesAdd) {
					...
					console.log(
						`add_float(${test.a}, ${test.b}) = ${result}, expected: ${test.expected} - ${passed ? "✅" : "❌"}`,
					);
				...
				if (testsPassed) {
					...
					console.error(
						"❌ f32.add test failed: add_float function returned incorrect results",
					);
					return false;
				}
			} else {
				console.error(
					"❌ f32.add test failed: add_float function not found in exports",
				);
				return false;
			}
			...
			if (typeof instance.exports.subtract_float === "function") {
				...
				for (const test of testCasesSub) {
					...
					const passed = isApproximatelyEqual(result, test.expected);
					console.log(
						`subtract_float(${test.a}, ${test.b}) = ${result}, expected: ${test.expected} - ${passed ? "✅" : "❌"}`,
					);
					if (!passed) testsPassed = false;
				}
				...
				if (testsPassed) {
					console.log(
						"✅ f32.sub test: subtract_float function works correctly!",
					);
				} else {
					console.error(
						"❌ f32.sub test failed: subtract_float function returned incorrect results",
					);
					return false;
				}
			} else {
				console.error(
					"❌ f32.sub test failed: subtract_float function not found in exports",
				);
				return false;
			}
			...
			if (typeof instance.exports.multiply_float === "function") {
				...
				for (const test of testCasesMul) {
					...
					const passed = isApproximatelyEqual(result, test.expected);
					console.log(
						`multiply_float(${test.a}, ${test.b}) = ${result}, expected: ${test.expected} - ${passed ? "✅" : "❌"}`,
					);
					if (!passed) testsPassed = false;
				}
				...
				if (testsPassed) {
					console.log(
						"✅ f32.mul test: multiply_float function works correctly!",
					);
				} else {
					console.error(
						"❌ f32.mul test failed: multiply_float function returned incorrect results",
					);
					return false;
				}
			} else {
				console.error(
					"❌ f32.mul test failed: multiply_float function not found in exports",
				);
				return false;
			}
			...
			if (typeof instance.exports.divide_float === "function") {
				...
				for (const test of testCasesDiv) {
					...
					const passed = isApproximatelyEqual(result, test.expected);
					console.log(
						`divide_float(${test.a}, ${test.b}) = ${result}, expected: ${test.expected} - ${passed ? "✅" : "❌"}`,
					);
					if (!passed) testsPassed = false;
				}
				...
				if (testsPassed) {
					console.log(
						"✅ f32.div test: divide_float function works correctly!",
					);
				} else {
					console.error(
						"❌ f32.div test failed: divide_float function returned incorrect results",
					);
					return false;
				}
			} else {
				console.error(
					"❌ f32.div test failed: divide_float function not found in exports",
				);
				return false;
			}
			...
			if (typeof instance.exports.float_constants === "function") {
				...
				const expected = Math.PI + Math.E; // pi + e
				const passed = isApproximatelyEqual(result, expected, 0.0001);
				console.log(
					`float_constants() = ${result}, expected: ${expected} - ${passed ? "✅" : "❌"}`,
				);

				if (passed) {
					console.log(
						"✅ f32.const test: float_constants function works correctly!",
					);
				} else {
					console.error(
						`❌ f32.const test failed: float_constants function returned ${result}, expected ${expected}`,
					);
					return false;
				}
			} else {
				console.error(
					"❌ f32.const test failed: float_constants function not found in exports",
				);
				return false;
			}
			...
			if (typeof instance.exports.equals_float === "function") {
				...
				for (const test of testCasesEq) {
					...
					console.log(
						`equals_float(${test.a}, ${test.b}) = ${result}, expected: ${test.expected} - ${passed ? "✅" : "❌"}`,
					);
					if (!passed) testsPassed = false;
				}
				...
				if (testsPassed) {
					...
					console.error(
						"❌ f32.eq test failed: equals_float function returned incorrect results",
					);
					return false;
				}
			} else {
				console.error(
					"❌ f32.eq test failed: equals_float function not found in exports",
				);
				return false;
			}
			...
			if (typeof instance.exports.not_equals_float === "function") {
				...
				for (const test of testCasesNe) {
					...
					const passed = result === test.expected;
					console.log(
						`not_equals_float(${test.a}, ${test.b}) = ${result}, expected: ${test.expected} - ${passed ? "✅" : "❌"}`,
					);
					if (!passed) testsPassed = false;
				}
				...
				if (testsPassed) {
					console.log(
						"✅ f32.ne test: not_equals_float function works correctly!",
					);
				} else {
					console.error(
						"❌ f32.ne test failed: not_equals_float function returned incorrect results",
					);
					return false;
				}
			} else {
				console.error(
					"❌ f32.ne test failed: not_equals_float function not found in exports",
				);
				return false;
			}
			...
			if (typeof instance.exports.less_than_float === "function") {
				...
				for (const test of testCasesLt) {
					...
					const passed = result === test.expected;
					console.log(
						`less_than_float(${test.a}, ${test.b}) = ${result}, expected: ${test.expected} - ${passed ? "✅" : "❌"}`,
					);
					if (!passed) testsPassed = false;
				}
				...
				if (testsPassed) {
					console.log(
						"✅ f32.lt test: less_than_float function works correctly!",
					);
				} else {
					console.error(
						"❌ f32.lt test failed: less_than_float function returned incorrect results",
					);
					return false;
				}
			} else {
				console.error(
					"❌ f32.lt test failed: less_than_float function not found in exports",
				);
				return false;
			}
			...
			if (typeof instance.exports.greater_than_float === "function") {
				...
				for (const test of testCasesGt) {
					...
					const passed = result === test.expected;
					console.log(
						`greater_than_float(${test.a}, ${test.b}) = ${result}, expected: ${test.expected} - ${passed ? "✅" : "❌"}`,
					);
					if (!passed) testsPassed = false;
				}
				...
				if (testsPassed) {
					console.log(
						"✅ f32.gt test: greater_than_float function works correctly!",
					);
				} else {
					console.error(
						"❌ f32.gt test failed: greater_than_float function returned incorrect results",
					);
					return false;
				}
			} else {
				console.error(
					"❌ f32.gt test failed: greater_than_float function not found in exports",
				);
				return false;
			}
			...
			if (typeof instance.exports.less_equal_float === "function") {
				...
				for (const test of testCasesLe) {
					...
					const passed = result === test.expected;
					console.log(
						`less_equal_float(${test.a}, ${test.b}) = ${result}, expected: ${test.expected} - ${passed ? "✅" : "❌"}`,
					);
					if (!passed) testsPassed = false;
				}
				...
				if (testsPassed) {
					console.log(
						"✅ f32.le test: less_equal_float function works correctly!",
					);
				} else {
					console.error(
						"❌ f32.le test failed: less_equal_float function returned incorrect results",
					);
					return false;
				}
			} else {
				console.error(
					"❌ f32.le test failed: less_equal_float function not found in exports",
				);
				return false;
			}
			...
			if (typeof instance.exports.greater_equal_float === "function") {
				...
				for (const test of testCasesGe) {
					...
					const passed = result === test.expected;
					console.log(
						`greater_equal_float(${test.a}, ${test.b}) = ${result}, expected: ${test.expected} - ${passed ? "✅" : "❌"}`,
					);
					if (!passed) testsPassed = false;
				}
				...
				if (testsPassed) {
					console.log(
						"✅ f32.ge test: greater_equal_float function works correctly!",
					);
				} else {
					console.error(
						"❌ f32.ge test failed: greater_equal_float function returned incorrect results",
					);
					return false;
				}
			} else {
				console.error(
					"❌ f32.ge test failed: greater_equal_float function not found in exports",
				);
				return false;
			}
			...
			if (typeof instance.exports.copysign_float === "function") {
				...
				for (const test of testCasesCopysign) {
					...
					if (test.expected === 0.0 || test.expected === -0.0) {
						...
						const expectedSign = 1 / test.expected === Number.NEGATIVE_INFINITY;
						const resultSign = 1 / result === Number.NEGATIVE_INFINITY;
						passed = expectedSign === resultSign;
					} else {
						passed =
							isApproximatelyEqual(Math.abs(result), Math.abs(test.expected)) &&
							Math.sign(result) === Math.sign(test.expected);
					}

					console.log(
						`copysign_float(${test.a}, ${test.b}) = ${result}, expected: ${test.expected} - ${passed ? "✅" : "❌"}`,
					);
					if (!passed) testsPassed = false;
				}
				...
				if (testsPassed) {
					console.log(
						"✅ f32.copysign test: copysign_float function works correctly!",
					);
				} else {
					console.error(
						"❌ f32.copysign test failed: copysign_float function returned incorrect results",
					);
					return false;
				}
			} else {
				console.error(
					"❌ f32.copysign test failed: copysign_float function not found in exports",
				);
				return false;
			}
			...
			if (typeof instance.exports.convert_i64_s === "function") {
				...
				for (const test of testCasesConvertI64S) {
					...
					const passed = isApproximatelyEqual(result, test.expected);
					console.log(
						`convert_i64_s_float(${test.a}) = ${result}, expected: ${test.expected} - ${passed ? "✅" : "❌"}`,
					);
					if (!passed) testsPassed = false;
				}
				...
				if (testsPassed) {
					console.log(
						"✅ f32.convert_i64_s test: convert_i64_s_float function works correctly!",
					);
				} else {
					console.error(
						"❌ f32.convert_i64_s test failed: convert_i64_s_float function returned incorrect results",
					);
					return false;
				}
			} else {
				console.error(
					"❌ f32.convert_i64_s test failed: convert_i64_s_float function not found in exports",
				);
				return false;
			}
			...
			if (typeof instance.exports.convert_i64_u === "function") {
				...
				for (const test of testCasesConvertI64U) {
					...
					const passed = isApproximatelyEqual(result, test.expected);
					console.log(
						`convert_i64_u_float(${test.a}) = ${result}, expected: ${test.expected} - ${passed ? "✅" : "❌"}`,
					);
					if (!passed) testsPassed = false;
				}
				...
				if (testsPassed) {
					console.log(
						"✅ f32.convert_i64_u test: convert_i64_u_float function works correctly!",
					);
				} else {
					console.error(
						"❌ f32.convert_i64_u test failed: convert_i64_u_float function returned incorrect results",
					);
					return false;
				}
			} else {
				console.error(
					"❌ f32.convert_i64_u test failed: convert_i64_u_float function not found in exports",
				);
				return false;
			}
			...
			if (typeof instance.exports.reinterpret_i32 === "function") {
				...
				const testCasesReinterpret = [
					...
					{ a: 0x7f800000, expected: Number.POSITIVE_INFINITY }, // Positive infinity
					{ a: 0xff800000, expected: Number.NEGATIVE_INFINITY }, // Negative infinity
				];
				...
				for (const test of testCasesReinterpret) {
					...
					console.log(
						`reinterpret_i32_float(0x${test.a.toString(16)}) = ${result}, expected: ${test.expected} - ${passed ? "✅" : "❌"}`,
					);
					if (!passed) testsPassed = false;
				}
				...
				if (testsPassed) {
					console.log(
						"✅ f32.reinterpret_i32 test: reinterpret_i32_float function works correctly!",
					);
				} else {
					console.error(
						"❌ f32.reinterpret_i32 test failed: reinterpret_i32_float function returned incorrect results",
					);
					return false;
				}
			} else {
				console.error(
					"❌ f32.reinterpret_i32 test failed: reinterpret_i32_float function not found in exports",
				);
				return false;
			}
