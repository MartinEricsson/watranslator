...
import testBrTableBoundaries from "./br-table/br-table-boundary-test.mjs";
...
import testGlobalInitErrors from "./global-variables/global-init-error-test.mjs";
...
import testBrowserShim from "./integrations/browser-shim-test.mjs";
import testBundleSize from "./integrations/bundle-size-test.mjs";
...
import testSourceMapRoundTrip from "./source-map/roundtrip-test.mjs";
...
async function runTests() {
	const testCases = [
		...
		{ name: "Br Table Boundaries", test: testBrTableBoundaries },
		...
		{ name: "Global Init Errors", test: testGlobalInitErrors },
		...
		{ name: "Browser Shim", test: testBrowserShim },
		...
		{ name: "LEB128 Boundaries", test: testLEB128Boundaries },
		...
		{ name: "Source Map Round Trip", test: testSourceMapRoundTrip },
