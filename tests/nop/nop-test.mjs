...
async function testNop(debug = false) {
	try {
		...
		const tests = [
			{
				name: "single_nop",
				fn: instance.exports.single_nop,
				args: [],
				expected: 42,
			},
			{
				name: "multiple_nops",
				fn: instance.exports.multiple_nops,
				args: [],
				expected: 123,
			},
			{
				name: "nop_in_block",
				fn: instance.exports.nop_in_block,
				args: [],
				expected: 99,
			},
			{
				name: "nop_in_if(1)",
				fn: instance.exports.nop_in_if,
				args: [1],
				expected: 1,
			},
			{
			...
			{
				name: "nop_in_loop",
				fn: instance.exports.nop_in_loop,
				args: [],
				expected: 3,
			},
			{
				name: "nop_stack_neutral",
				fn: instance.exports.nop_stack_neutral,
				args: [],
				expected: 30,
			},
		];
