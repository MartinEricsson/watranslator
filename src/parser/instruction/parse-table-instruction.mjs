...
export function parseTableInstruction(instrToken, position) {
    ...
    if (instrToken === 'table.size') {
        ...
        const tableIndex = parseInt(getToken(), 10);
    ...
    if (instrToken === 'table.init') {
        ...
        const elementIndex = parseInt(getToken(), 10);
        const tableIndex = parseInt(getToken(), 10);
    ...
    if (instrToken === 'table.copy') {
        // Generated by 🤖
        const destTableIndex = parseInt(getToken(), 10);
        const srcTableIndex = parseInt(getToken(), 10);
