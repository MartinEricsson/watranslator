...
function parseOffsetAndAlign(inlineAttributes = []) {
...
export function parseSIMDMemory(instrToken, position) {
	...
	if (
		...
		const { align, offset } = parseOffsetAndAlign(inlineAttributes);
	...
	if (
		...
		const { align, offset } = parseOffsetAndAlign(inlineAttributes); // Generated by 🤖
