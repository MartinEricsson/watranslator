	...
	if (opcode === "v128.const") {
		...
		if (immediates.length !== expectedValues) {
			throw createError(
				...
				null,
				null,
				`v128.const with shape ${shape} requires exactly ${expectedValues} values`,
			);
		}
	...
	if (opcode === "i8x16.shuffle") {
		...
		if (laneIndices.length !== 16) {
			throw createError(
				...
				null,
				null,
				"i8x16.shuffle requires exactly 16 lane indices",
			);
		}
		...
		for (let i = 0; i < 16; i++) {
			...
			if (index < 0 || index > 31) {
				throw createError(
					...
					null,
					null,
					"i8x16.shuffle lane indices must be 0-31",
				);
			}
	...
	if (opcode === "i8x16.extract_lane_u") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 15) {
			throw createError(
				...
				null,
				null,
				"i8x16.extract_lane_u requires lane index 0-15",
			);
		}
	...
	if (opcode === "i8x16.extract_lane_s") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 15) {
			throw createError(
				...
				null,
				null,
				"i8x16.extract_lane_s requires lane index 0-15",
			);
		}
	...
	if (opcode === "i8x16.replace_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 15) {
			throw createError(
				...
				null,
				null,
				"i8x16.replace_lane requires lane index 0-15",
			);
		}
	...
	if (opcode === "i16x8.extract_lane_s") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 7) {
			throw createError(
				...
				null,
				null,
				"i16x8.extract_lane_s requires lane index 0-7",
			);
		}
	...
	if (opcode === "i16x8.extract_lane_u") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 7) {
			throw createError(
				...
				null,
				null,
				"i16x8.extract_lane_u requires lane index 0-7",
			);
		}
	...
	if (opcode === "i16x8.replace_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 7) {
			throw createError(
				...
				null,
				null,
				"i16x8.replace_lane requires lane index 0-7",
			);
		}
	...
	if (opcode === "i32x4.extract_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 3) {
			throw createError(
				...
				null,
				null,
				"i32x4.extract_lane requires lane index 0-3",
			);
		}
	...
	if (opcode === "i32x4.replace_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 3) {
			throw createError(
				...
				null,
				null,
				"i32x4.replace_lane requires lane index 0-3",
			);
		}
	...
	if (opcode === "i64x2.extract_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 1) {
			throw createError(
				...
				null,
				null,
				"i64x2.extract_lane requires lane index 0-1",
			);
		}
	...
	if (opcode === "i64x2.replace_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 1) {
			throw createError(
				...
				null,
				null,
				"i64x2.replace_lane requires lane index 0-1",
			);
		}
	...
	if (opcode === "f32x4.extract_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 3) {
			throw createError(
				...
				null,
				null,
				"f32x4.extract_lane requires lane index 0-3",
			);
		}
	...
	if (opcode === "f32x4.replace_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 3) {
			throw createError(
				...
				null,
				null,
				"f32x4.replace_lane requires lane index 0-3",
			);
		}
	...
	if (opcode === "f64x2.extract_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 1) {
			throw createError(
				...
				null,
				null,
				"f64x2.extract_lane requires lane index 0-1",
			);
		}
	...
	if (opcode === "f64x2.replace_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 1) {
			throw createError(
				...
				null,
				null,
				"f64x2.replace_lane requires lane index 0-1",
			);
		}
