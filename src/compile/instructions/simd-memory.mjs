	...
	if (type === "v128.load8_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 15) {
			throw createError(
				...
				null,
				null,
				"v128.load8_lane requires lane index 0-15",
			);
		}
	...
	if (type === "v128.load16_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 7) {
			throw createError(
				...
				null,
				null,
				"v128.load16_lane requires lane index 0-7",
			);
		}
		bytes.push(laneIndex);
		return true;
	...
	if (type === "v128.load32_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 3) {
			throw createError(
				...
				null,
				null,
				"v128.load32_lane requires lane index 0-3",
			);
		}
		bytes.push(laneIndex);
		return true;
	...
	if (type === "v128.load64_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 1) {
			throw createError(
				...
				null,
				null,
				"v128.load64_lane requires lane index 0-1",
			);
		}
		bytes.push(laneIndex);
		return true;
	...
	if (type === "v128.store8_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 15) {
			throw createError(
				...
				null,
				null,
				"v128.store8_lane requires lane index 0-15",
			);
		}
		bytes.push(laneIndex);
		return true;
	...
	if (type === "v128.store16_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 7) {
			throw createError(
				...
				null,
				null,
				"v128.store16_lane requires lane index 0-7",
			);
		}
		bytes.push(laneIndex);
		return true;
	...
	if (type === "v128.store32_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 3) {
			throw createError(
				...
				null,
				null,
				"v128.store32_lane requires lane index 0-3",
			);
		}
		bytes.push(laneIndex);
		return true;
	...
	if (type === "v128.store64_lane") {
		...
		if (laneIndex === undefined || laneIndex < 0 || laneIndex > 1) {
			throw createError(
				...
				null,
				null,
				"v128.store64_lane requires lane index 0-1",
			);
		}
		bytes.push(laneIndex);
		return true;
