 ...
 */
function recordSourceMap(instr, sourceMapManager, funcIndex, body, options, position = null) {
...
export function compileControlFlow(
	...
	if (instr.type === "block") {
		...
		if (instr.endPosition) {
			recordSourceMap(instr, sourceMapManager, funcIndex, body, options, instr.endPosition);
		}
	...
	if (instr.type === "if") {
		...
		if (instr.elseInstructions && instr.elseInstructions.length > 0) {
			...
			if (instr.elsePosition) {
				recordSourceMap(instr, sourceMapManager, funcIndex, body, options, instr.elsePosition);
			}
