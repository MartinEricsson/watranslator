...
export function memorySection(module, binary) {
    // Check if we have any memories or data segments
    if ((module.memories && module.memories.length > 0) || (module.datas && module.datas.length > 0)) {
        ...
        if (module.memories && module.memories.length > 0) {
            ...
            memoriesToProcess = [...module.memories].sort((a, b) => {
            ...
            // Create default memory if we only have data segments
            memoriesToProcess = [{
                min: 1, // Default to 1 page when we have data segments
                max: null,
                shared: false,
                index: 0
            }];
