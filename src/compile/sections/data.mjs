...
export function dataCountSection(module, binary) {
	// Generated by 🤖: Do not emit if no data segments
	if (!module.datas || module.datas.length === 0) return;

	const dataCountSection = [SECTION.DATA_COUNT]; // Section ID
...
export function dataSection(module, binary) {
	console.log(
		"DEBUG: dataSection called, module.datas.length =",
		module.datas ? module.datas.length : "undefined",
	); // Generated by 🤖
	// Generated by 🤖: Do not emit if no data segments
	if (!module.datas || module.datas.length === 0) return;

	const dataSection = [SECTION.DATA]; // Section ID
	...
	for (const data of module.datas) {
		...
		if (
			data.bytes &&
			typeof data.bytes === "object" &&
			Array.isArray(data.bytes.processedBytes)
		) {
