...
export function codeSection(functions, globals, module, binary, sourceMapManager = null, options = {}) {
	...
	if (functions.length > 0) {
		...
		// For each function
		for (let funcIndex = 0; funcIndex < nonImportedFunctions.length; funcIndex++) {
			...
			for (const instr of func.instructions) {
				compileInstruction(instr, func, body, functions, globals, module, sourceMapManager, funcIndex, options);
			}
